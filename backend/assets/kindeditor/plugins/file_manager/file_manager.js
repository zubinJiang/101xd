...
var JSON_URL = '../../../../blogArticleEdit?action=fileBrowse';
...
KE.event.ready(function() {
	...
	orderType.options[1] = new Option(lang.fileDate, 'DATE');
	orderType.options[2] = new Option(lang.fileSize, 'SIZE');
	orderType.options[3] = new Option(lang.fileType, 'TYPE');
