$(document).ready(function(){
    ...
    function get_date_by_jquery () {
        $('.dead_line').datepicker({inline:true, dateFormat:'yy-mm-dd'});
    }
   ...
   function contactDialogPage() {
    ...
    function get_confirm(){
         $("#log .confirm").click(function(){
            ...
            $.get("services/manageBuy.php", {action:'confirm', id:ref}, function(data){
                    if(data) {
                         $('[id="'+ref+'"]').hide();
                    } else {
                        alert("确认供货失败");
        ...
        $("#log .refused").click(function(){
            ...
            $.get("services/manageBuy.php", {action:'refused', id:ref}, function(data){
                    if(data) {
                         $('[id="'+ref+'"]').hide();
                    } else {
                        alert("拒绝供货失败");
...
function yanzheng_int(){
    ...
    $('input[name=title]').blur(function(){
        var title = $(this).val();
        if(title.length>=50) {
            $(".mess_title").html('输入的标题必须在50个汉字内，请修改！');
            $(".mess_title").show();
...
function releasenets_other(){
    ...
    $("#releasenetsother .part").click(function(){  
      ...
      $("#releasenetsother .tmp").click(function(){    
           $("#releasenetsother .mess_date").show();     
      });

      $("#releasenetsother .agent").click(function(){  
           $("#releasenetsother .mess_agent").show();   
      });

      $("#releasenetsother .identity").click(function(){   
           $("#releasenetsother .mess_agent").hide();   
      });

      $("#releasenetsother .fast").click(function(){   
           $("#releasenetsother .mess_date").hide();   
      });
      ...
      $('#releasenetsother #start_date').datepicker({inline: true, dateFormat:'yy-mm-dd' });

      $('#releasenetsother #line_date').datepicker({ inline: true, dateFormat:'yy-mm-dd'});
}

    releasenets_submit();
    releasenets_other();
    releasenets_province();
...
validate_request();
    ...
    function form_blur(){
        ...
        $("input[name=p_name]").focus(function(){
                $(this).val('');
                });

        $("input[name=p_tel]").focus(function(){
