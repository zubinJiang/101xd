<?php
class VipmanagementPresenter extends InitPresenter 
{
    ...
    public function index($user_id){
        ...
        $data = $this->vipproduct->getVipproductList($user_id, $page, $num);
    ...
    public function search($user_id){
        ...
        */
        ...
        $data = $this->vipproduct->getSearchVipproduct($user_id, $key, $page, $num);
